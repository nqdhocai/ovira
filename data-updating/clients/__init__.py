...
from clients.services_manager import ServicesClient


class Clients:
    _service_client: ServicesClient | None = None
    ...
    @classmethod
    def get_service_client(cls) -> ServicesClient:
        if not cls._service_client:
            cls._service_client = ServicesClient()
